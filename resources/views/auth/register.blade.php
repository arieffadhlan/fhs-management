                                ...
                                @csrf
                                    <div class="form-group row">
                                        <div class="col-12 mb-1">
                                            ...
                                            <input id="username" name="username" type="text" value="{{ old('username') }}" class="input form-control" placeholder="johndoe" aria-label="name" aria-describedby="basic-addon1" required autocomplete="off" />
                                            @error('username')
                                                <div class="fw-bold text-danger mt-1">{{ $message }}</div>
                                            @enderror
                                            ...
                                            <input id="email" name="email" type="email" value="{{ old('email') }}" class="input form-control" placeholder="example@gmail.com" aria-label="email" aria-describedby="basic-addon1" required autocomplete="off" />
                                            @error('email')
                                                <div class="fw-bold text-danger mt-1">{{ $message }}</div>
                                            @enderror
