<x-app-layout title="Penambahan Data Pembelian Customer">
    <h2 class="m-0">Penambahan Data Pembelian Customer</h2>
    ...
    <x-form-card>
        ...
        <form method="POST" action="{{ route('pembelianCustomer.store') }}" enctype="multipart/form-data"
            class="row g-3">
            @csrf
            <div class="col-md-9">
                <div class="container-fluid">
                    ...
                    <input type="number" min="1" value="{{ old('jumlah_pembelian') }}" name="jumlah_pembelian"
                    ...
                    <input type="date" min="1" value="{{ old('tanggal_masuk') }}" name="tanggal_masuk"
