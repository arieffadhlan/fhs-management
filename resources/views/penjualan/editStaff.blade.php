<x-app-layout title="Perubahan Data Penjualan Staff">
    ...
    <x-form-card>
        ...
        <form method="POST" action="{{ route('penjualanStaff.update', $penjualan->id) }}"
            ...
            <div class="col-md-9">
                <div class="container-fluid">
                    ...
                    <input type="number" min="1" value="{{ old('jumlah_penjualan', $penjualan->jumlah_penjualan) }}"
                        name="jumlah_penjualan" class="form-control" id="jumlah_penjualan">
                    ...
                    <input type="date" name="tanggal_penjualan"
                        value="{{ old('tanggal_penjualan', $penjualan->tanggal_penjualan) }}" class="form-control"
