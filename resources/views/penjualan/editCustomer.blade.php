<x-app-layout title="Ubah Data Pembelian Customer">
    ...
    <x-form-card>
        ...
        <form method="POST" action="{{ route('pembelianCustomer.update', $pembelians->id) }}" enctype="multipart/form-data" class="row g-3">
            @method('put')
            @csrf
            <div class="col-md-9">
                <div class="container-fluid">
                    ...
                    <input type="number" min="1" value="{{ old('jumlah_pembelian', $pembelians->jumlah_pembelian) }}" name="jumlah_pembelian" class="form-control" id="jumlah_pembelian">
                    ...
                    <input type="date" value="{{ old('tanggal_masuk', $pembelians->tanggal_masuk) }}" name="tanggal_masuk" class="form-control" id="tanggal_masuk">
                    @error('tanggal_masuk')
                        <div class="fw-bold text-danger mt-1">{{ $message }}</div>
                    @enderror
                    <br>
