<x-app-layout title="Perubahan Data Staff">
        ...
        <form method="POST" action="{{ route('DataStaff.update', $staff->id) }}" enctype="multipart/form-data">
            ...
            <div class="col-md-9">
                <div class="container-fluid">
                    <label for="nama_staff" class="form-label fw-bold">Nama Lengkap<sup
                            style="color: red">*</sup></label>
                    <input type="text" name="nama_staff" id="nama_staff"
                        value="{{ old('nama_staff', $staff->nama_staff) }}" class="form-control">
                    @error('nama_staff')
                    ...
                    <input type="date" min="1" value="{{ old('tanggal_lahir', $staff->tanggal_lahir) }}"
                    ...
                    <input type="text" name="alamat_staff" id="alamat_barang"
                        value="{{ old('alamat_staff', $staff->alamat_staff) }}" class="form-control">
                    @error('alamat_staff')
                        <div class="fw-bold text-danger mt-1">{{ $message }}</div>
                    @enderror
                    <br>
                    ...
                    <input id="email_staff" name="email_staff" type="email"
                        value="{{ old('email_staff', $staff->email_staff) }}" class="input form-control" />
                    @error('email_staff')
                        <div class="fw-bold text-danger mt-1">{{ $message }}</div>
                    @enderror
                    <br>
                    ...
                    <input type="tel" name="telp_staff" value="{{ old('telp_staff', $staff->telp_staff) }}"
                        id="typePhone" class="form-control" />
                    @error('telp_staff')
                        <div class="fw-bold text-danger mt-1">{{ $message }}</div>
                    @enderror
                    <br>
