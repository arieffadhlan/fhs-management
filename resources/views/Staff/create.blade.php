<x-app-layout title="Penambahan Data Staff">
        ...
        <form method="POST" action="{{ route('DataStaff.store') }}" enctype="multipart/form-data">
            ...
            <div class="col-md-9">
                <div class="container-fluid">
                    ...
                    <input type="text" name="nama_staff" id="nama_barang" value="{{ old('nama_staff') }}"
                        class="form-control">
                    @error('nama_staff')
                    ...
                    <input type="date" min="1" value="{{ old('tanggal_lahir') }}" name="tanggal_lahir"
                    ...
                    <input type="text" name="alamat_staff" id="alamat_barang" value="{{ old('alamat_staff') }}"
                        class="form-control">
                    @error('alamat_staff')
                        <div class="fw-bold text-danger mt-1">{{ $message }}</div>
                    @enderror
                    ...
                    <input id="email_staff" name="email_staff" type="email" value="{{ old('email_staff') }}"
                    ...
                    <input type="tel" name="telp_staff" value="{{ old('telp_staff') }}" id="typePhone"
                        class="form-control" />
                    @error('telp_staff')
                        <div class="fw-bold text-danger mt-1">{{ $message }}</div>
                    @enderror
